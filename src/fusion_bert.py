...
from utils.utils import mkdir_p, merge_args_yaml, load_models 
from utils.prepare import (prepare_train_val_loader, 
...
class Fusion:
    def __init__(self, args):
        ...
        if args.fusion_type == "linear":
            ...
            self.fusion_net = Working(channel_dim = args.gl_img_dim)
